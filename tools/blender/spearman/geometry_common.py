...
PARTS = {"body": 0, "arm_weapon": 1, "leg_l": 2, "leg_r": 3,
         ...
         "forearm_spear": 9, "hand_spear": 10}
# The weapon's pivot is the centre of its grip, where the wrist turns it.
PIVOTS = {"leg_l": (0.115, 0, 0.91), "leg_r": (-0.115, 0, 0.91),
          "arm_spear": (-0.224, 0, 1.435), "arm_shield": (0.224, 0, 1.435),
          "forearm_spear": (-0.31, 0.07, 1.20),
          "hand_spear": (-0.36, -0.16, 1.205),
          "weapon": (-0.373, -0.219, 1.185)}
# Joints inside a part, exported as `joint_<name>` empties.
JOINTS = {"elbow": PIVOTS['forearm_spear'], "wrist": PIVOTS['hand_spear']}
...
class Geometry:
    ...
    def mesh(self, material):
        mesh = bpy.data.meshes.new("spearman_L0_geometry")
