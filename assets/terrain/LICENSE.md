...
The classic meadow shader reconstructs grass/dry coverage along the eastern transition using neighboring albedo samples 16 m apart. Local luminance variation preserves surface grain, and small coverage interruptions use fixed world-space sizes. The transition corridor is specific to the layout artwork; the source image and native grass scale remain independent of this blending.
